export const DESCRIPTIVE_PAGE_NAME = "Windows Interfaces";
export const PAGE_NAME = "Interfaces";
export const ELEMENT_NAME = "Interface";
export const PAGE_PATH = "windows_interfaces";
export const FILE_NAME_EXPORT_ALL_DATA = "all_windows_interfaces";
