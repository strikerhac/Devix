export const DESCRIPTIVE_PAGE_NAME = "Servers All Interfaces";
export const PAGE_NAME = "Interfaces";
export const ELEMENT_NAME = "Interface";
export const PAGE_PATH = "servers_all_devices_interfaces";
export const FILE_NAME_EXPORT_ALL_DATA = "all_servers_devices_interfaces";
