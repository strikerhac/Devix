export const DESCRIPTIVE_PAGE_NAME = "Firewalls Interfaces";
export const PAGE_NAME = "Interfaces";
export const ELEMENT_NAME = "Interface";
export const PAGE_PATH = "firewalls_interfaces";
export const FILE_NAME_EXPORT_ALL_DATA = "all_firewalls_interfaces";
