export const DESCRIPTIVE_PAGE_NAME = "Wireless Interfaces";
export const PAGE_NAME = "Interfaces";
export const ELEMENT_NAME = "Interface";
export const PAGE_PATH = "wireless_interfaces";
export const FILE_NAME_EXPORT_ALL_DATA = "all_wireless_interfaces";
